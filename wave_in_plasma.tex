...
と変形できる。これは
\begin{equation}
	\frac{c^2k^2}{\omega^2}\qty(\omega^2-\omega^2_c) = \omega^2-\omega^2_{\text{UH}} - \frac{(\omega^2_{pe}\omega_c/\omega)^2}{\omega^2-\omega^2_{\text{UH}}}
\end{equation}
となる。位相速度$v_{\phi}$を用いると$c^2k^2/\omega^2 = c^2/v^2_{\phi}$となることから、分散関係は
\begin{equation}
	\frac{c^2}{v^2_{\phi}} = \frac{\omega^2-\omega^2_{\text{UH}} - (\omega^2_{pe}\omega_c/\omega)^2}{\omega^2-\omega^2_c}
\end{equation}
となる。ここで、$\omega^2_{\text{UH}} = \omega^2_{pe} + \omega^2_c$と戻すと
\begin{equation}
	\frac{c^2}{v^2_{\phi}} = \frac{\omega^2 - \omega^2_{pe} - \omega^2_c - \omega^4_{pe}\omega^2_c/\omega^2}{\omega^2-\omega^2_c}
	= 1-\frac{\omega^2_{pe}\qty(1 + \omega^2\omega)}{\omega^2-\omega^2_c}
\end{equation}
